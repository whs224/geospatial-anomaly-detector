...
A distributed intelligence pipeline that ingests live flight telemetry over the New York City metro airspace (JFK, LaGuardia, Newark, and Teterboro), detects kinematic anomalies in real time, and visualizes high-priority targets — with the evidence behind every alert — for operator review.
